...
benchmaq sky bench -c benchmaq/vllm/stt/examples/stt_benchmark_skypilot_a100.yaml
```

See [benchmaq/vllm/stt/examples/](./benchmaq/vllm/stt/examples/) for SkyPilot STT configs.
